...
Car.create(make: "Rolls Royce", model: "Limousine", photo_url: "https://images.squarespace-cdn.com/content/v1/51a34089e4b062a74b58079a/1373189083716-7C36M5UUQDK4WL4UDEZQ/Rolls+Royce+Silver+Shadow+cc.JPG?format=2500w", price: "60gbp", location: "Shoreditch", user_id: User.all.sample.id)
