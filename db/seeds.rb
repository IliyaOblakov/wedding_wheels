...
Car.create(make: "Bentley", model: "Noble Lady", photo_url: "https://weddingcarhire.co.uk/images/gallery/classic-wedding-cars/noble-lady-bentley-r/957.jpg", price: "£60", location: "Camden", user_id: User.all.sample.id)
Car.create(make: "Bentley", model: "Silver Lady", photo_url: "https://weddingcarhire.co.uk/images/gallery/classic-wedding-cars/silver-lady-bentley/1048.jpg", price: "£120", location: "Golders Green", user_id: User.all.sample.id)
Car.create(make: "Rolls Royce", model: "Phantom", photo_url: "https://www.lastretchlimos.co.uk/wp-content/uploads/2013/10/rr-phantom-hire.jpg", price: "£80", location: "Richmond", user_id: User.all.sample.id)
